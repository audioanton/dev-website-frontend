...
function Header({ title, subtitle, titleFont }: HeaderData) {
  return (
    <div className="absolute top-0 left-0 bg-gray-800 w-full md:w-3/4 h-[125px]">
      <div className="absolute bottom-0 px-[50px] py-[15px] xl:px-[300px]">
        ...
        <h2 className="text-2xl text-shadow-lg/30 text-shadow-black">
          {subtitle}
        </h2>
        <div className="h-[2px] bg-linear-to-r from-slate-950 to-white w-50 blur-[1px]"></div>
      </div>
    </div>
  );
}
